#!/usr/bin/env bash
#SBATCH --job-name=quest-qft-gpu-mpi-a40-r2
...
#SBATCH --output=experiments/results/raw/qft_gpu_mpi_a40_r2_%j.out
#SBATCH --error=experiments/results/raw/qft_gpu_mpi_a40_r2_%j.err
...
info "=== QFT GPU+MPI Benchmark — A40 × ${NUM_RANKS} ranks ==="
info "Node: $(hostname)"
info "Total qubits: ${Q_MAX}  |  Ranks: ${NUM_RANKS}  |  GPUs: ${NUM_RANKS}"
info "Per-GPU local qubits: $((Q_MAX - 1)) (each rank holds half the statevector)"
