#!/usr/bin/env bash
#SBATCH --job-name=quest-qft-gpu-mpi-2080ti-r1
...
#SBATCH --output=experiments/results/raw/qft_gpu_mpi_2080ti_r1_%j.out
#SBATCH --error=experiments/results/raw/qft_gpu_mpi_2080ti_r1_%j.err
...
info "=== QFT GPU+MPI Benchmark — 2080 Ti × ${NUM_RANKS} rank(s) ==="
info "Node: $(hostname)"
