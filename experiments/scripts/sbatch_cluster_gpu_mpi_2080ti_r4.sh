#!/usr/bin/env bash
#SBATCH --job-name=quest-qft-gpu-mpi-2080ti-r4
...
#SBATCH --output=experiments/results/raw/qft_gpu_mpi_2080ti_r4_%j.out
#SBATCH --error=experiments/results/raw/qft_gpu_mpi_2080ti_r4_%j.err
...
info "Per-GPU local qubits: $((Q_MAX - 2)) (each rank holds 1/4 of the statevector)"
